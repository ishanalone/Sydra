...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        view = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 30, 10)];
        view.layer.shouldRasterize = YES;
        view.layer.masksToBounds = YES;
        view.layer.cornerRadius = 3;
        view.layer.backgroundColor = [UIColor clearColor].CGColor;// FSCalendarStandardScopeHandleColor.CGColor;
        UIImageView* image = [[UIImageView alloc] initWithFrame:view.bounds];
        [image setImage:[UIImage imageNamed:@"more"]];
